            ...
            <div class="col-lg-7 col-md-6 ">
                <div class="row ">
                    <div class="col-md-6 mb-5 ">
                        ...
                        <p><i class="fa fa-map-marker-alt mr-2 "></i>Bhopalpura,Udaipur,India</p>
                        <p><i class="fa fa-phone-alt mr-2 "></i>8233151745</p>
                        <p><i class="fa fa-envelope mr-2 "></i>8233151745</p>
                        <div class="d-flex justify-content-start mt-4 ">
                            <a class="btn btn-outline-light btn-social mr-2 " href="https://www.facebook.com/GS-Logistics-101358322228562/ "><i class="fab fa-facebook-f "></i></a>
                            <a class="btn btn-outline-light btn-social " href="8233151745 "><i class="fab fa-instagram "></i></a>
                        </div>
                    </div>
                    <div class="col-md-6 mb-5 ">
